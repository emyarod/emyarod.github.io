...
export default function Flattish() {
  return (
    <div>
      ...
      <p>While most of the icons come from Google's open source icon library, several of Flattish's sprite animations were custom made in Photoshop.</p>
      <p>
